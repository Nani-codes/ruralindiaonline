...
// <Image
//         src="../../../src/images/file-under-construction-lmms-wiki-4.png" // Path to your image in the public directory
...
const underconstruction = () => {
	return (
      ...
      <div style={{ width: '100%', display: 'flex', justifyContent: 'center', color: 'white', marginLeft: 'auto', marginRight: 'auto', textAlign: 'center' }}>
					<svg
						version='1.0'
            ...
            color='#B82929'
						width='1024.000000pt'
						height='442.000000pt'
						viewBox='0 0 1024.000000 442.000000'
						preserveAspectRatio='xMidYMid meet'>
						<g transform='translate(0.000000,442.000000) scale(0.100000,-0.100000)' stroke='none'>
							<path
								d='M874 2710 c-111 -16 -213 -100 -253 -208 -21 -57 -22 -61 -19 -827
...
-15z'
							/>
							<path
								d='M926 2510 c-37 -11 -83 -55 -107 -102 -18 -36 -19 -68 -19 -718 0
...
3 -49z'
							/>
							<path
								d='M2034 2029 c-18 -19 -19 -42 -22 -298 -4 -303 0 -353 29 -382 23 -23
81 -25 103 -4 25 25 27 65 24 371 -3 271 -4 293 -22 313 -26 29 -86 29 -112 0z'
							/>
							<path
								d='M6214 2029 c-18 -20 -19 -40 -19 -339 0 -299 1 -319 19 -339 13 -14
31 -21 57 -21 69 0 69 2 69 366 0 298 -1 322 -18 337 -27 24 -85 22 -108 -4z'
							/>
							<path
								d='M2599 2036 c-2 -2 -3 -63 -1 -135 l3 -131 40 0 c53 0 74 13 88 51 24
71 8 189 -29 209 -18 10 -93 14 -101 6z'
							/>
							<path
								d='M5080 1895 l0 -145 25 -6 c38 -9 93 4 105 26 5 10 10 68 10 128 0
130 -7 142 -88 142 l-52 0 0 -145z'
							/>
							<path
								d='M5630 1905 l0 -135 50 0 c78 0 90 18 90 135 0 115 -13 135 -92 135
l-48 0 0 -135z'
							/>
							<path
								d='M7324 2027 c-2 -7 -3 -67 -2 -133 l3 -119 47 -3 c36 -2 51 1 67 17
...
export async function getServerSideProps({ locale }) {
  // Fetching the locale-specific messages and any other data you need
  const messages = require(`@/locales/${locale}.json`);
  const data = {}; // Your data fetching logic here
  const libraries = {}; // Libraries or other static data fetching logic
