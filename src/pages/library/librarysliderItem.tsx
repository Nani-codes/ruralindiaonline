...
export default function LibrarySliderItems({ item, createdDate }: any) {
	// console.log(item);
	...
	return (
      ...
      `}
			...
			<div
				className={`description  ${styles['description']} sm:mt-0 lg:mt-[1.5rem] xl:mt-[1.5rem] 2xl:mt-[1.5rem] 3xl:mt-[1.5rem] overflow-hidden xs:w-1/4 sm:w-1/1 sm2:w-1/2 sm3:w-1/2 md:w-[200px] w-[201px] min-h-[75px]`}>
				...
				<div>
					<h2
						className={`desc  text-[0.75rem] text-[#828282] not-italic	 font-medium font-sans line-clamp-1 leading-[160%] tracking-[-0.0225rem] mt-[1rem] mb-[0.75rem]	`}>
						<div
